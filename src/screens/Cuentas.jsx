...
import { balanceOfCard, clampDay } from "../lib/finance";
                    ...
                    <li key={card.id} className="rounded-lg px-3 py-3" style={{ background: C.bg, border: `1px solid ${C.borderSoft}`, opacity: card.excluded ? 0.55 : 1 }}>
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="text-right shrink-0">
                          ...
                          <span className="font-mono text-base" style={{ color: isCredit ? (bal > 0 ? C.red : C.green) : (bal < 0 ? C.red : C.green), fontVariantNumeric: "tabular-nums" }}>
                            {money(bal)}
                          </span>
                        </div>
                      </div>
